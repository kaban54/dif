...
\centering
\includegraphics[width=0.8\linewidth]{images/plotimg112.png}
...
$$x^{2} $$равна
$$2 \cdot x$$Таким образом, производная функции
$$x^{2} $$равна
$$2 \cdot x$$\begin{figure}[h]
\centering
\includegraphics[width=0.8\linewidth]{images/plotimg113.png}
